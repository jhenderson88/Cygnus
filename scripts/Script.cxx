...
void RunFitter(const char* nuclfile = "NucleusFile.txt", const char* datafile = "Data.txt", int threads = 1){
	...
	double tmin[6] = {20,30,40,130,140,150};
	double tmax[6] = {30,40,50,140,150,160};
	bool tarDet[6] = {false,false,false,false,false,false};
	for(int i=0;i<6;i++){
	...
	expts->WriteIntegralFits("CrossSections.root");
