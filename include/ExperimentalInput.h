...
class ExptData {
	...
	public:
		...
		///	Uncertainty = e
		///
		ExptData(int i, int f, double c, double e)			{ StateIndex_I = i; StateIndex_F = f; Counts = c; UpUncertainty =  e; DnUncertainty =  e;	}		
		///
		...
		///
		ExptData(int i, int f, double c, double ue, double de)		{ StateIndex_I = i; StateIndex_F = f; Counts = c; UpUncertainty = ue; DnUncertainty = de;	}
		~ExptData()	{;}
